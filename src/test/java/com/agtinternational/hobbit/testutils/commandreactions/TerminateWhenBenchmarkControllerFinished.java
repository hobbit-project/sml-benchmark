 ...
 */
public class TerminateWhenBenchmarkControllerFinished implements CommandReaction {
    private final CommandQueueListener commandQueueListener;
    private final ComponentsExecutor componentsExecutor;

    public TerminateWhenBenchmarkControllerFinished(CommandQueueListener commandQueueListener,
