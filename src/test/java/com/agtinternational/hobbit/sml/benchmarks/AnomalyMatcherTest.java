...
import com.agtinternational.hobbit.sml.benchmarks.sml.InstantAndText;
import com.agtinternational.hobbit.sml.benchmarks.sml.SMLDataChecker;
 ...
 */
public class AnomalyMatcherTest {
    ...
    public void checkLatencyCalculatedCorrectly() {
        ...
        SMLDataChecker dataChecker = new SMLDataChecker(new KeyValue(), new DataPointAsAnomaly());
    ...
    private static class DataPointAsAnomaly implements SMLDataChecker.AnomalyDetectorBuilder {
        @Override
        public SMLDataChecker.AnomalyDetector buildFrom(KeyValue keyValue, SMLDataChecker.AnomalyListener anomalyListener) throws Exception {
