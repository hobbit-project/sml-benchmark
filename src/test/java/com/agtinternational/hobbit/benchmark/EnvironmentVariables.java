...
public class EnvironmentVariables {
    ...
    protected void setupBenchmarkEnvironmentVariables(String experimentId, String systemUri) {
    ...
    protected void setupSystemEnvironmentVariables() {
        Model emptyModel = ModelFactory.createDefaultModel();
        environmentVariables.set(Constants.SYSTEM_PARAMETERS_MODEL_KEY, RabbitMQUtils.writeModel2String(emptyModel));
    }

    protected void setupCommunicationEnvironmentVariables(String rabbitHostName, String experimentId) {
